...
<div class="content">
    ...
    <c:forEach items="${accounts}" var="account">
        <div class="account">
            ...
            <a class="btn btn-blue" href="app?c=update_account&id=${account.id}&lang=${locale}"><fmt:message key="table.edit"/></a>
            <a class="btn btn-red" href="app?c=delete_account&id=${account.id}&lang=${locale}"><fmt:message key="table.delete"/></a>
        </div>
    </c:forEach>
