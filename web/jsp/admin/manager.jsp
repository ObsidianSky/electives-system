...
<div class="content">
    <div class="actions">
        <a class="btn" href="app?c=add_course&lang=${locale}"><fmt:message key="course_table.add"/></a>
    </div>
    ...
    <c:forEach items="${courses}" var="course">
        <div class="course">
            ...
            <a class="btn btn-blue" href="app?c=update_course&cid=${course.id}&lang=${locale}"><fmt:message key="table.edit"/></a>
            <a class="btn btn-red" href="app?c=delete_course&cid=${course.id}&lang=${locale}"><fmt:message key="table.delete"/></a>
        </div>
    </c:forEach>
