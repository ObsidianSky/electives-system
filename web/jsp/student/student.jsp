    ...
    <c:if test="${not empty courses}">
        <c:forEach items="${courses}" var="course">
            <div class="course">
                ...
                <a class="btn btn-red" href="app?c=leave_course&cid=${course.id}&lang=${locale}"><fmt:message key="student.account.leave"/></a>
            </div>
        </c:forEach>
        <a class="btn-blue" href="app?c=courses&lang=${locale}"><fmt:message key="student.account.select_course"/></a>
    </c:if>
